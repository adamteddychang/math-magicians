...
class Calc extends React.Component {
  ...
  handleClick = (e) => {
    this.setState((prevState) => calculate(prevState, e));
  }
...
<div className="buttons">
  ...
  <button type="button" id = "%" className="button" onClick={() => this.handleClick('%')}>%</button>
  <button type="button" id = "&divide;" className="button orange" onClick={() => this.handleClick('÷')}>÷</button>
  ...
  <button type="button" id = "&times;" className="button orange" onClick={() => this.handleClick('x')}>x</button>
