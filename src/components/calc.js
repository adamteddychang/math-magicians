...
<div className="buttons">
  ...
  <button type="button" id = "%" className="button" onClick={() => handleClick('%')}>%</button>
  <button type="button" id = "&divide;" className="button orange" onClick={() => handleClick('÷')}>÷</button>
  ...
  <button type="button" id = "&times;" className="button orange" onClick={() => handleClick('x')}>x</button>
